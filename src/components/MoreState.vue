    ...
    <template>
      <el-tabs type="border-card" v-model="activeName" @tab-click="handleClick">
        <el-tab-pane label="数据库备份" name="databaseBackup">
          <el-table v-if="this.databaseBackup"
                    :data="this.databaseBackup.slice((currentPage-1)*pagesize,currentPage*pagesize)"
                    style="width: 100%">
            ...
            <el-table-column prop="timeConsuming"
        ...
        <el-tab-pane label="数据库恢复" name="databaseRestore">
          <el-table v-if="this.databaseRestore"
                    :data="this.databaseRestore.slice((currentPage-1)*pagesize,currentPage*pagesize)"
                    style="width: 100%">
            <el-table-column min-width="50"
                             align="center"
                             label="序号"
        ...
        <el-tab-pane label="一键接管" name="initconnNum">
          <el-table v-if="this.initconnNum"
                    :data="this.initconnNum.slice((currentPage-1)*pagesize,currentPage*pagesize)"
                    style="width: 100%">
            <el-table-column min-width="50"
                             align="center"
                             label="序号"
        ...
        <el-tab-pane label="文件备份" name="filehostBackup">
          <el-table v-if="this.filehostBackup"
                    :data="this.filehostBackup.slice((currentPage-1)*pagesize,currentPage*pagesize)"
                    style="width: 100%">
            <el-table-column min-width="50"
                             align="center"
                             label="序号"
        ...
        <el-tab-pane label="文件恢复" name="filehostRestore">
          <el-table v-if="this.filehostRestore"
                    :data="this.filehostRestore.slice((currentPage-1)*pagesize,currentPage*pagesize)"
                    style="width: 100%">
            <el-table-column min-width="50"
                             align="center"
                             label="序号"
        ...
        <el-tab-pane label="虚拟机备份" name="vmBackup">
          <el-table v-if="this.vmBackup"
                    :data="this.vmBackup.slice((currentPage-1)*pagesize,currentPage*pagesize)"
                    style="width: 100%">
            <el-table-column
              min-width="50"
              align="center"
