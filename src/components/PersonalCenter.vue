<template>
    <div>
        ...
        <el-dialog title="更改信息" :visible.sync="dialogVisible" width="30%">
            <el-form ref="form" :model="form" :rules="rules" label-width="80px">
                <el-form-item label="新用户名" required prop="new_name">
                    <el-input v-model="form.newUsername"></el-input>
                </el-form-item>
                <el-form-item label="新密码" required prop="new_pass">
                    <el-input type="password" v-model="form.newPassword"></el-input>
                </el-form-item>
                    <el-form-item label="原始密码" required prop="old_pass">
    ...
    export default {
        data() {
            return {
                ...
                rules: {
                    new_name: [
                        {required="true",message: '请输入新用户名',trigger:'change,blur'}
                    ],
                    new_pass: [
