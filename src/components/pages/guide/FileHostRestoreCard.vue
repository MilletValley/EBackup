  ...
  <el-card class="restoreCard"
    ...
    <el-row type="flex">
        ...
        <el-form label-width="100px"
          ...
          <el-form-item label="恢复方向"
            ...
            <el-tooltip :content="restorePlan.sourcePath"
                        placement="top"
                        effect="dark">
              <span class="pathOverFlow">{{ restorePlan.sourcePath }}</span>
            </el-tooltip>
            <i class="el-icon-d-arrow-right"></i>
            <el-tooltip :content="restorePlan.targetPath"
                        placement="top"
                        effect="dark">
              <span class="pathOverFlow">{{ restorePlan.targetPath }}</span>
            </el-tooltip>
          </el-form-item>
          <el-form-item label="挂载点路径"
            ...
            <el-tooltip :content="restorePlan.pointPath"
                        placement="top"
                        effect="dark">
              <span class="pathOverFlow">{{ restorePlan.pointPath }}</span>
            </el-tooltip>
          </el-form-item>
      ...
      <el-col :span="6"
        ...
        <ul>
          ...
          <li>
            <h5>文件总大小</h5>
            <div>{{fmtSizeFn(restorePlan.size) || '-'}}</div>
          </li>
          <li>
            <h5>已恢复大小
            ...
            <div>{{fmtSizeFn(restorePlan.progress) || '-'}}</div>
          </li>
        </ul>
      </el-col>
    </el-row>
      ...
      <el-col :span="8"
        ...
        <el-card shadow="always"
          ...
          <el-row>
            <el-col :span="12">
              <el-tooltip :content="`文件备份源路径: ${restoreFile.sourcePath}`"
                ...
                <div class="wordsOverFlow">
                  <i-icon name="fileSourcePath" class="restoreFileInfoIcon"></i-icon>
            ...
            <el-col :span="12" class="restoreFileState">
              <el-tooltip content="已恢复大小"
                          placement="top"
                          :open-delay="300">
                <el-progress :percentage="isNaN(restoreFile.percentage)?0:restoreFile.percentage" class="restoreFileProgress">
                </el-progress>
              </el-tooltip>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="12">
              <el-tooltip :content="`恢复集存放路径: ${restoreFile.targetPath}`"
                          ...
                          :open-delay="300">
                <div class="wordsOverFlow">
                  <i-icon name="fileTargetPath" class="restoreFileInfoIcon" style="margin-right: 0.5em;"></i-icon>
                  <el-tag class="childFileTag"
                          type="warning"
                          size="mini">
          ...
          <el-row>
            <el-col :span="12">
              <i-icon name="size" class="restoreFileInfoIcon"></i-icon>
              <el-tooltip content="源文件总大小"
                          placement="right"
                          :open-delay="300">
                <span>{{ fmtSizeFn(restoreFile.sourceSize) }}</span>
              </el-tooltip>
            </el-col>
            <el-col :span="12"
                    v-if="[1,2,3].includes(restoreFile.state)"
    ...
    <transition name="el-zoom-in-center">
      <div class="balloons"
           ...
           v-show="['waiting', 'showRecords'].includes(nextStep) && !isShow">
