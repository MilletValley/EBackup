              ...
              <el-row class="margin-right5">
                <el-row>
                  ...
                  <el-col :span="8">
                    ...
                    <div v-if="['oracle', 'sqlserver', 'mysql', 'db2', 'sybase', 'cache', 'insql', 'informix', 'dm'].includes(target)">
                      <el-col :span="8">
                ...
                <el-row class="machineRow">
                  ...
                  <div v-if="['oracle', 'sqlserver', 'mysql', 'db2', 'sybase', 'cache', 'insql', 'informix', 'dm'].includes(target)">
                    <el-col :span="8">
                      <el-form-item  :label="['sqlserver', 'mysql', 'dm', 'sybase', 'cache', 'insql', 'informix'].includes(target) ? '数据库名：':'实例名：'" >
                  ...
                  <div v-if="['oracle', 'sqlserver', 'mysql', 'db2', 'dm', 'sybase', 'cache', 'informix', 'insql', 'vmware', 'hw'].includes(target)">
                    <el-col :span="8">
...
export default {
  ...
  computed: {
    ...
    nameLabel() {
      if (['sqlserver', 'mysql','dm', 'sybase', 'cache', 'informix', 'insql'].includes(this.target)) {
        return '数据库名';
    ...
    hostIpLabel() {
      if (['oracle', 'db2', 'sqlserver', 'mysql','dm', 'sybase', 'cache', 'insql', 'informix'].includes(this.target)) {
        return '恢复设备IP';
