            ...
            <el-form label-position="right"
              ...
              <el-row class="margin-right5">
                ...
                <el-row class="machineRow">
                  ...
                  <div v-if="['oracle', 'sqlserver', 'mysql', 'db2', 'dm', 'sybase', 'cache', 'insql', 'informix'].includes(target)">
                    <el-col :span="8">
                  ...
                  <div v-if="['oracle', 'sqlserver', 'mysql', 'db2', 'dm', 'sybase', 'vmware', 'hw', 'cache', 'insql', 'informix'].includes(target)">
                    <el-col :span="8">
            ...
            <el-table-column type="expand">
              <template slot-scope="scope">
                <el-form inline
                  ...
                  <el-form-item :class="$style.detailFormItem"
                                 v-if="['oracle', 'sqlserver', 'mysql', 'db2', 'dm', 'sybase', 'cache', 'insql', 'informix', 'vmware', 'hw'].includes(target)"
                                label="文件名">
