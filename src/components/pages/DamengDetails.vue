<template>
  <section>
    ...
    <!-- <backup-plan-update-modal type="dm"
    ...
    <restore-plan-update-modal type="dm"
                               :database="details"
    ...
    <single-restore-create-modal type="dm"
...
import { detailPageMixin } from '../mixins/dbDetailsPageMixin';
// import {
//   fetchOne
// } from '../../api/database';
