<template>
  <section>
    <div :id="id" :style="{width: '100%', height: '100%',marginLeft:'0px', 'text-align': 'center'}">
    </div>
    <!-- <div :style="{width: '100%', height: '100%',marginTop: '10px', 'text-align': 'center'}">
...
export default {
  ...
  methods: {
    draw() {
      ...
      const stage = new cax.Stage((width + 20), (height + 20), `#${this.id}`);
      stage.empty();
      for (let i = 0; i < 1; i++) {
